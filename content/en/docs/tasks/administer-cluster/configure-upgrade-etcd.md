...
```
note: if etcd deployed as a static pod on cluster installed by kubeadm tool you shall edit --data-dir and hostPath for the volume called etcd-data in /etc/kubernetes/manifests/etcd.yaml to the new path of restored etcd backup.
